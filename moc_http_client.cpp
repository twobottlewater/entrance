/****************************************************************************
** Meta object code from reading C++ file 'http_client.hpp'
**
...
#error "The header file 'http_client.hpp' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 11, 13), // "requestFailed"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 12), // "errorMessage"
QT_MOC_LITERAL(4, 39, 10), // "onFinished"
QT_MOC_LITERAL(5, 50, 14), // "QNetworkReply*"
QT_MOC_LITERAL(6, 65, 5) // "reply"

    },
    "HttpClient\0requestFailed\0\0errorMessage\0"
...
void HttpClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->requestFailed((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&HttpClient::requestFailed)) {
                *result = 0;
                return;
            }
        }
